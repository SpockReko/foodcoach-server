...
public class GlobalDummyModels {
    ...
    public static Food getFoodDummyCarrot() {
        return new Food("Carrot", 300, 317.0, 8.1, 0.6, 0.2, 2.5, 0.0, 0.0,
    ...
    public static Food getFoodDummyParsnip() {
        return new Food("Parsnips", 309, 266.0, 11.8, 0.5, 0.4, 4.5, 0.0, 2.0,
                0.3, 0.03, 0.0, 6.5, 0.0, 0.4, 19.0, 0.07, 0.07, 0.8,
                0.9, 16.4, 40.0, 1.0, 0.5, 29.0, 390.0, 14.0, 25.0, 0.2, 0.4);
    }

    public static Food getFoodDummyChicken() {
        return new Food("Chicken", 11565, 456.0, 0.0, 22.4, 2.0, 0.0, 0.0, 86.6,
    ...
    public static Food getFoodDummyBean() {
        return new Food("Beans", 373, 464.7, 14.0, 8.3, 0.8, 7.0, 0.0, 12.74,
    ...
    public static Food getFoodDummyRedLenses() {
        return new Food("Red Lenses", 31225, 424.4, 15.6, 7.6, 0.4, 1.9, 0.0, 30.58, 20.0,
    ...
    public static Food getFoodDummySteak() {
        return new Food("Beef, ", 31145, 795.43, 1.4, 22.19, 14.375, 0.0, 0.0, 1054.51,
