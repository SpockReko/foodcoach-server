...
public class WeekMenuTest {
    ...
    public static void init() {
        ...
        HashMap<RDI, Double> nutrientsContent = Algorithms.nutrientsContent(resultingMenu);
        result = Algorithms.L2Norm(nutrientsNeed, nutrientsContent, resultingMenu);
    ...
    private static Recipe createOptimalRecipeForSpecificUser(User user) {
        ...
        Sugars sugers = new Sugars(0F, 0F, 0F, 0F);
        Fats fats =
            new Fats(Float.parseFloat(user.hmap.get(RDI.Fat) + "") * convertToOnePortion, 0F, 0F,
        ...
        Vitamins vitamins = new Vitamins(0F, 0F,
            ...
            Float.parseFloat(user.hmap.get(RDI.VitaminEMG) + "") * convertToOnePortion, 0F,
            ...
            Float.parseFloat(user.hmap.get(RDI.NiacinMG) + "") * convertToOnePortion, 0F);
        Minerals minerals =
            new Minerals(Float.parseFloat(user.hmap.get(RDI.FolateUG) + "") * convertToOnePortion,
                ...
                Float.parseFloat(user.hmap.get(RDI.Magnesium) + "") * convertToOnePortion, 0F, 0F,
        ...
        ingredients.add(new Ingredient(
            new FoodItem("perfectFood", "perfektus foodus", 9999, "perfekt",
                Float.parseFloat(user.hmap.get(RDI.CaloriKcal) + "") * convertToOnePortion, 0F,
                Float.parseFloat(user.hmap.get(RDI.Carbohydrates) + "") * convertToOnePortion,
                Float.parseFloat(user.hmap.get(RDI.Protein) + "") * convertToOnePortion, 0F, 0F, 0F,
                0F, 0F, 0F, 0F, sugers, fats, vitamins, minerals), amount));
